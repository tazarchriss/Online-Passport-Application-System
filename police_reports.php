<?php
  ...
  $sql="SELECT * FROM user,passport_request,admin WHERE user.id=passport_request.applicant AND admin.userid='$id' AND passport_request.region=admin.region AND passport_request.req_status='Crime Checked' ";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-1">
          <div class="col-sm-6">
            <h6 class="text-olive"><i class="fa fa-download"></i> Pending Applications</h6>
          </div><!-- /.col -->
          <div class="col-sm-6">
     ...
     <section class="content">
       <div class="container-fluid">
        ...
        <div class="card mt-2">
          ...
          ?>
          <h4 class="text-center text-danger"> No Pasport Requests Available ! </h4>
            ...
            <tr>
              ...
              <td>
                  <div class="text-center">
                    <a href="configurations/approve.php?id=<?php echo $row['req_id'];?>" class="text-center badge badge-success">Approve</a>
