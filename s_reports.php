<?php
  ...
  $sql="SELECT * FROM user,passport_request,police WHERE user.id=passport_request.applicant AND police.userid='$id' AND passport_request.region=police.station  AND passport_request.req_status!='Pending' ";
            ...
            <tr>
              ...
              <td>
                  <div class="text-center">
                    <a href="crime.php?id=<?php echo $row['req_id'];?>" class="text-center badge badge-success">View Report</a>
