  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="text-olive text-left"><i class="fa fa-user-tie"></i> Register Police Officer</h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="col-md-12 mx-auto">
        <div class="card">
            ...
            <div class="card-body p-3">
                  ...
                  <form action="Configurations/AddPolice.php"  method="POST" class="form-group">
              ...
              <div class="row">        
                    ...
                    <div class="form-group col-md-6 float-left">
                        <label for="email" class="text-olive"> Police ID</label>
                        <input type="text" name="pID" id="email" class="form-control" placeholder="Enter Police ID">
                    </div>
                    ...
                    <div class="form-group col-md-6 float-left">
                        <label for="password" class="text-olive">Station</label>
                        <input type="text" name="station" id="password" class="form-control" placeholder="Enter Station">
                    </div>
                    ...
                    <button name="register" type="submit" class="btn bg-olive btn-block">
