...
<?php
  ...
  $sql="SELECT * FROM user,admin,region WHERE 
  user.id=admin.userid
  AND region.reg_id=admin.region ";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h4 class="text-olive"><i class="fa fa-user-tie"></i> Admininstrators</h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <!-- Main content -->
     <section class="content">
       <div class="container-fluid">
        ...
        <a href="AddAdministrator.php" class="btn col-md-4  mt-2 bg-olive text-left text-light"><i class="fa fa-plus"></i> Register Administrator </a>
            ...
            <tr>
              ...
              <td>
                  <div class="text-center">
                      <a class="bg-olive p-1" href="SingleUser.php?id=<?php echo $row['id'];?>"><i class="fa fa-eye "></i></a>
