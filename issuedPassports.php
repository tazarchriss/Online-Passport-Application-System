<?php
  ...
  AND passport_request.req_status='Issued'  
  AND passport.pass_status='Issued'";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-1">
          <div class="col-sm-6">
            <h6 class="text-olive"><i class="fa fa-file"></i> Issued Passports</h6>
          </div><!-- /.col -->
          <div class="col-sm-6">
