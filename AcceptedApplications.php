<?php
  ...
  $sql="SELECT * FROM user,passport_request,admin WHERE user.id=passport_request.applicant AND admin.userid='$id' AND passport_request.region=admin.region AND passport_request.req_status='Accepted'  ";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-1">
          <div class="col-sm-6">
            <h6 class="text-olive"><i class="fa fa-download"></i> Accepted Applications</h6>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <tr>
              ...
              <td>
                  <div class="text-center">
                    <a href="configurations/decline.php?id=<?php echo $row['req_id'];?>" class="text-center badge badge-danger col-md-12">Decline</a>
