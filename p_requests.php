     ...
     <section class="content">
       <div class="container-fluid">
        ...
        <div class="card mt-2">
          ...
          ?>
          <h4 class="text-center text-danger"> No Crime Requests Requested ! </h4>
            ...
            <tr>
              ...
              <td>
                  <div class="text-center">
                    <a href="crime.php?id=<?php echo $row['req_id'];?>" class="text-center badge badge-success">Check Crime</a>
