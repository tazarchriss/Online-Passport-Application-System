<?php
  ...
  AND passport.pass_status='Not Issued'";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-1">
          <div class="col-sm-6">
            <h6 class="text-olive"><i class="fa fa-file"></i> Issue Passport</h6>
          </div><!-- /.col -->
          <div class="col-sm-6">
     ...
     <section class="content">
       <div class="container-fluid">
        ...
        <div class="card mt-2">
          ...
          ?>
          <h6 class="text-center text-danger"> No Pasports Which have been Issued Available ! </h6>
...
?>
              <td>
                  <div class="text-center">
                    <a href="configurations/issue.php?id=<?php echo $row['req_id'];?>" class="text-center badge badge-success ">Issue</a>
                    <a href="configurations/issue.php?id=<?php echo $row['req_id'];?>" class="text-center badge badge-danger ">Mismatch</a>
